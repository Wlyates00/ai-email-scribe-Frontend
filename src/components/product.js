...
const product = () => {
  return (
    <Container className="product-container">
      <Row>
        <Col className="product-text d-flex justify-content-end align-items-center">
        ...
        <Col className="gif-container d-flex justify-content-start">
          <img src={"/demo.gif"} className="gif-1"></img>
        </Col>
      </Row>
      <Row>
        <Col className="gif-container gap d-flex justify-content-end flip">
          <img src={"/composeEmail.PNG"} className="gif-2"></img>
        </Col>
